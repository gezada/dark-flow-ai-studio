...
import { BarChart, Calendar, ChevronDown, ChevronRight, Home, Image, Inbox, LayoutDashboard, LogOut, Plus, Settings, Upload, Users } from "lucide-react";
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar">
        <nav className="flex flex-col gap-1 px-2 py-4">
          ...
          <div className="px-3 py-2">
            {collapsed ? <NavItem href="/ideas" icon={<LayoutDashboard />} label="Ideas" collapsed={collapsed} isActive={isActive("/ideas") || isActive("/headlines") || isActive("/thumbnails") || isActive("/scripts")} /> : <Collapsible open={creativeWorkflowOpen} onOpenChange={setCreativeWorkflowOpen} className="w-full">
